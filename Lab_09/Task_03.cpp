...
int main()
{
    ...
    inOrder(root);
    cout << endl;
    cout << "Preorder Traversal of the Tree before Deletion: ";
    preOrder(root);
    cout << endl;
    cout << "Postorder Traversal of the Tree before Deletion: ";
    postOrder(root);
    cout << endl
         << endl;
    ...
    inOrder(root);
    cout << endl;
    cout << "Preorder Traversal of the Tree after Deletion: ";
    preOrder(root);
    cout << endl;
    cout << "Postorder Traversal of the Tree after Deletion: ";
    postOrder(root);
    cout << endl;
